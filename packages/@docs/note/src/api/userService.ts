...
import { User } from '@/types/service/dto/';

export const getUsers: Function = (): AxiosPromise<Array<User>> => {
  return axios.get('https://microsoftedge.github.io/Demos/json-dummy-data/64KB.json');
};

export const createUser: Function = (param: { id: string }): AxiosPromise<User> => {
